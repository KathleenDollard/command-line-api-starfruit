...
namespace Playground
{
    ...
    public class PropertySymbolsSymbolAttributesCommand
    {
        ...
        public class List : PropertySymbolsSymbolAttributesCommand
        {
            [Option(Aliases = new string[] { "o" })]
            public FileInfo Output { get; set; }
        }

        public class Update : PropertySymbolsSymbolAttributesCommand
        {
            [Argument]
        ...
        public class Check : PropertySymbolsSymbolAttributesCommand
        {
        ...
        public Dictionary<string, string> HelpText = new Dictionary<string, string>
            {
                ...
                { startName + $"+{updateName}+{nameof(Update.FilePath)}","Path to the global.json to update" },
