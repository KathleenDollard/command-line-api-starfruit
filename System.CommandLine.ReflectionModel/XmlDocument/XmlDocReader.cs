...
namespace System.CommandLine.ReflectionModel.XmlDocument
{
    public class XmlDocReader
    {
        ...
        public bool TryGetMethodDescription(MethodInfo info, out MethodHelpMetadata commandHelpMetadata)
        {
            ...
            commandHelpMetadata = new MethodHelpMetadata();
        ...
        internal bool TryGetTypeDescription(Type type, out TypeHelpMetadata typeHelpMetadata)
        {
            typeHelpMetadata = null;
            return false;
