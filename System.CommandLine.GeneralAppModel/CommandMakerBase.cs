...
namespace System.CommandLine.GeneralAppModel
{
        ...
        where TModelBinder : class
    {
        ...
        protected abstract TModelBinder? MakeModelBinder(CommandDescriptor commandDescriptor);
        protected abstract void BindOption(TModelBinder modelBinder, TItemTarget target, TOption option);
        protected abstract void BindArgument(TModelBinder modelBinder, TItemTarget target, TArgument option);
        protected abstract void BindSubCommand(TModelBinder modelBinder, TCommandTarget target, TCommand option);
